...
def download_images_from_naver_blog(
    blog_url: str, output_dir: str = "images", headless: bool = True
):
    ...
    img_elements = driver.find_elements(
        By.CSS_SELECTOR, "img.se-image-resource.egjs-visible"
    )
    ...
    with tqdm(total=len(img_elements), desc="下載圖片") as pbar:
            ...
            try:
                ...
                for _ in range(6):  # 最多等 1.2 秒
                    popup_imgs = driver.find_elements(
                        By.CSS_SELECTOR, "div.cpv__img_wrap img.cpv__img"
                    )
                    if popup_imgs:
